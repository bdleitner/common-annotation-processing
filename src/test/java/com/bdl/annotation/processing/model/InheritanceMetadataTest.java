...
public class InheritanceMetadataTest {
  ...
  public void testSimpleInheritance() {
    TypeElement simpleElement = elements.getTypeElement("com.bdl.annotation.processing.model.Simple");
  ...
  public void testParameterizedInheritance() {
    TypeElement simpleElement = elements.getTypeElement("com.bdl.annotation.processing.model.ExtendedParameterized");
    TypeMirror inherited = simpleElement.getInterfaces().get(0);
    InheritanceMetadata actual = InheritanceMetadata.fromType((DeclaredType) inherited);
    assertThat(actual).isEqualTo(InheritanceMetadata.builder()
  ...
  public void testExtendedParameterizedInheritance() {
    TypeElement simpleElement = elements.getTypeElement("com.bdl.annotation.processing.model.ExtendedExtendedParameterized");
    TypeMirror inherited = simpleElement.getInterfaces().get(0);
    InheritanceMetadata actual = InheritanceMetadata.fromType((DeclaredType) inherited);
    assertThat(actual).isEqualTo(InheritanceMetadata.builder()
        ...
        .setClassMetadata(ClassMetadata.builder()
            ...
            .setType(TypeMetadata.builder()
                ...
                .build())
            .addAnnotation(AnnotationMetadata.builder().setType(TestingTypes.SOME_ANNOTATION).build())
